    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_action_log", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Queues_Robots_AllocatedRobotId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueData_Queues_QueueId",
                        column: x => x.QueueId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueueResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QueueResults_Queues_QueueId",
                        column: x => x.QueueId,
                        principalTable: "Queues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QueueResults_Robots_ProcessedByRobotId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueueTag", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QueueTag_Queues_QueueId",
                        column: x => x.QueueId,
                        principalTable: "Queues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueueResultAttachment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QueueResultAttachment_QueueResults_QueueResultId",
                        column: x => x.QueueResultId,
                        principalTable: "QueueResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "QueueResultMessage",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QueueResultMessage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QueueResultMessage_QueueResults_QueueResultId",
                        column: x => x.QueueResultId,
                        principalTable: "QueueResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueData_QueueId",
                table: "QueueData",
                column: "QueueId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueResultAttachment_QueueResultId",
                table: "QueueResultAttachment",
                column: "QueueResultId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueResultMessage_QueueResultId",
                table: "QueueResultMessage",
                column: "QueueResultId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueResults_ProcessedByRobotId",
                table: "QueueResults",
                column: "ProcessedByRobotId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueResults_QueueId",
                table: "QueueResults",
                column: "QueueId");

            migrationBuilder.CreateIndex(
                name: "IX_Queues_AllocatedRobotId",
                table: "Queues",
                column: "AllocatedRobotId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueTag_QueueId",
                table: "QueueTag",
                column: "QueueId");

            migrationBuilder.CreateIndex(
                name: "IX_user_action_log_Timestamp",
                table: "user_action_log",
                column: "Timestamp");

            migrationBuilder.CreateIndex(
                name: "IX_user_action_log_UserId",
                table: "user_action_log",
                column: "UserId");
        }
