...
namespace Robot.ED.FacebookConnector.Service.RPA.Middleware;
...
public class TokenAuthenticationMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, AppDbContext dbContext)
    {
        ...
        // Validate token in database (from User table for RPA)
        var tokenExists = await dbContext.Users.AnyAsync(u => u.TokenValue == token);
